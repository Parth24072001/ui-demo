...
const testimonials = [
  ...
  },
  {
    ...
    description: (
      <p>
        Implementing customer prediction model has drastically improved our
        targeting strategy.
  ...
  },
  {
    ...
    description: (
      <p>
        As a startup, we need to move fast and stay ahead. automated coding
  ...
  },
  {
    ...
    description: (
      <p>
        AI-driven voice synthesis has made creating global products a breeze.
  ...
  },
  {
    ...
    description: (
      <p>
        Leveraging AI for our financial models has given us an edge in
        predictive accuracy.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        supply chain optimization tools have drastically reduced our operational
        costs.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        By integrating sustainable energy solutions, seen a significant
  ...
  },
  {
    ...
    description: (
      <p>
        market analysis AI has transformed how we approach fashion trends.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        AI-driven personalized learning plans have doubled student performance
        metrics.
        <Highlight>Education tailored to every needs.</Highlight> Transforming
  ...
  },
  {
    ...
    description: (
      <p>
        With s AI-powered security systems, our data protection levels are
        unmatched.
  ...
  },
  {
    ...
    description: (
      <p>
        AI has streamlined our creative process, enhancing productivity and
        innovation.
  ...
  },
  {
    ...
    description: (
      <p>
        insights into startup ecosystems have been invaluable for our growth and
        funding strategies.
...
export function SocialProofTestimonials3() {
  return (
